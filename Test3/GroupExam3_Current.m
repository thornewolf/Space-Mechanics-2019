...
%%
fprintf('Problem 1:\n')
fprintf('Initial Radius in Mars Centered Inertial (MCI): %g %g %g km \n',vr1_MCIBefore)
fprintf('Initial Velocity in Mars Centered Inertial (MCI): %g %g %g km \n',vv1_MCIBefore)
...
%%
fprintf('Problem 3:\n')
fprintf('Velocity magnitude: %g \n',v1After)
fprintf('Flight Path Angle: %g \n', fpaAfter)
...
%%
fprintf('Problem 4:\n')
fprintf('New Radius Vector: %g %g %g \n',vr2_MCIBefore)
fprintf('New Velocity Vector: %g %g %g \n',vv2_MCIBefore)
